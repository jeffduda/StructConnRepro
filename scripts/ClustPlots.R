...
pEulerAAL <- read.csv("../data/Statistics/clustering_euler_aal.csv" )
pFactAAL  <- read.csv("../data/Statistics/clustering_fact_aal.csv" )
pRkAAL <- read.csv("../data/Statistics/clustering_rk4_aal.csv" )
pTendAAL <- read.csv("../data/Statistics/clustering_tend_aal.csv" )
  
pEulerDKT <- read.csv("../data/Statistics/clustering_euler_dkt31.csv" )
pFactDKT  <- read.csv("../data/Statistics/clustering_fact_dkt31.csv" )
pRkDKT <- read.csv("../data/Statistics/clustering_rk4_dkt31.csv" )
pTendDKT <- read.csv("../data/Statistics/clustering_tend_dkt31.csv" )
...
png( filename="../data/Statistics/clust_plot.png", width=1000, height=300 )
print(pathplot)
dev.off()
